...
class Blog1s extends StatefulWidget {
  Blog1s({Key key}) : super(key: key);
  _Blog1state createState() => _Blog1state();
}

class _Blog1state extends State<Blog1s> {
            ...
            ListView(
              ...
              children: <Widget>[
                Card(
                  ...
                  child:
                      Image.asset('assets/images/blog9.jpg', fit: BoxFit.fill),
                ),
                Card(
                  elevation: 5,
